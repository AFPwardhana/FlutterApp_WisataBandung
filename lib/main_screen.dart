  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: _tourismPlaceList.length,
        itemBuilder: (context, index) => FlatButton(
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return DetailScreen(
                place: _tourismPlaceList[index],
              );
            }));
          },
          child: Card(
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          _tourismPlaceList[index].name,
                          style: TextStyle(fontSize: 16.0),
                        ),
                        SizedBox(
                          height: 10,
                        ),
                        Text(_tourismPlaceList[index].location),
                      ],
                    ),
                  ),
                ),
